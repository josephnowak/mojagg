"""NaN-aware exponentially weighted moving covariance matrices."""
...
struct MoveExpNanCovMatrixKernel[dtype: DType](
    GUFuncKernel, ImplicitlyCopyable
):
    """SIMD-driver-compatible ``(m,n), (m,n) -> (m,n,n)`` covariance."""
