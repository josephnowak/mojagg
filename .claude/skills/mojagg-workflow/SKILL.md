...
Before modifying a kernel, driver, binding, or benchmark, read `.claude/skills/mojagg/SKILL.md` (or the mirrored `.agents/skills/mojagg/SKILL.md`) and follow its parity and performance rules.
